...
#MERGE FILES
multiple_files <- list.files("./n_management_box/Data/yc_output_55", full.names = T)
grid10_soils_dt5 <- readRDS("./n_management_box/Data/Grid/grid10_soils_dt5.rds") %>% data.table()
...
saveRDS(plant_dates_output, "./n_management_box/Data/files_rds/plant_dates_output.rds") 
# ---------------------------------------------------------------------
plant_dates_output <- readRDS( "./n_management_box/Data/files_rds/plant_dates_output.rds") 
...
weather_historic_dt <- readRDS('./n_management_box/Data/met_files/weather_historic_dt2019.rds')
...
tmap_save(frost_map, filename = "./n_management_box/Data/figures/frost_map.pdf", height = 8, width = 6)  
...
saveRDS(plant_dates_dt, "./n_management_box/Data/files_rds/plant_dates_dt.rds")

#------------------------------------------------------------------------------
#Go to the R in CPSC and save it there to avoid the error in the cluster
plant_dates_dt <- readRDS("C:/Users/germanm2/Box Sync/My_Documents/n_management_box/Data/files_rds/plant_dates_dt.rds")
saveRDS(plant_dates_dt, "C:/Users/germanm2/Box Sync/My_Documents/n_management_box/Data/files_rds/plant_dates_dt.rds")
