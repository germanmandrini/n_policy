...
fields_list_dt <- full_fields_dt[,.(.N), by = .(id_10, id_field)][,-'N'] #one row by field
...
process_field_economics <- function(j){
  ...
  field_soils_dt <- grid10_soils_dt5[id_10 == field_n$id_10 &
  ...
  z_even = z_odd+1
  z_select <- if(field_n$id_field %in% c(1,3)){z_odd} else{z_even}
  ic_field_dt <- yc_yearly_dt3[id_10 == field_n$id_10 & mukey %in% unique(field_soils_dt$mukey) & z %in% z_select]
  ...
  #===================================================================================================================
  # 8) PREDICT WITH REGIONAL RF 2 - UR 
  # GET THE RECOMMENDATION FOR THE Z11-30 FOR EACH MUKEY
  ...
  #===================================================================================================================
  # 9) PREDICT WITH REGIONAL MODEL 2 -VR
  ...
  #===================================================================================================================
  # 10) PREDICT WITH REGIONAL RF 2 - UR 
  # GET THE RECOMMENDATION FOR THE Z11-30 FOR EACH MUKEY
  ...
  #===================================================================================================================
  # 11) PREDICT WITH REGIONAL MODEL 2 -VR
  ...
  #===================================================================================================================
  # 12) PREDICT WITH REGIONAL RF 2 - UR 
  # GET THE RECOMMENDATION FOR THE Z11-30 FOR EACH MUKEY
  ...
  #===================================================================================================================
  # 13) PREDICT WITH REGIONAL MODEL 2 -VR
  ...
  #===================================================================================================================
  # 14) PREDICT WITH REGIONAL RF 2 - UR 
  # GET THE RECOMMENDATION FOR THE Z11-30 FOR EACH MUKEY
  ...
  #===================================================================================================================
  # 15) PREDICT WITH REGIONAL MODEL 2 -VR
  ...
  #===================================================================================================================
  # 16) PREDICT WITH REGIONAL RF 2 - UR 
  # GET THE RECOMMENDATION FOR THE Z11-30 FOR EACH MUKEY
  ...
  #===================================================================================================================
  # 17) PREDICT WITH REGIONAL MODEL 2 -VR
  ...
  #===================================================================================================================
  # 18) PREDICT WITH REGIONAL RF 2 - UR 
  # GET THE RECOMMENDATION FOR THE Z11-30 FOR EACH MUKEY
  ...
  #===================================================================================================================
  # 19) PREDICT WITH REGIONAL MODEL 2 -VR
  ...
  #===================================================================================================================
  # 30) PREDICT WITH REGIONAL - UR 
  # GET THE RECOMMENDATION FOR THE Z11-30 FOR EACH MUKEY
  
  prediction_set_aggregated[,eonr_pred := ceiling(predict(reg_model_stuff$xgb_1, prediction_set_aggregated)/10)*10]
  ...
  #===================================================================================================================
  # 31) PREDICT WITH REGIONAL -VR
  
  # GET THE RECOMMENDATION FOR THE Z11-30 FOR EACH MUKEY AND PERFORMANCE EVALUATION
  testing_set <- ic_field_dt[!z %in% training_z] %>% 
    .[,eonr_pred := ceiling(predict(reg_model_stuff$xgb_1, . )/10)*10] %>%
    .[N_fert == eonr_pred] %>% 
    .[,c("mukey", "z", "id_10", "area_ha", "Yld", "leach_n2", "n_deep_v5", "N_fert", 'P' )] %>% .[order(mukey, z)]
  ...
  #===================================================================================================================
  # 32) PREDICT WITH REGIONAL - UR 
  # GET THE RECOMMENDATION FOR THE Z11-30 FOR EACH MUKEY
  
  prediction_set_aggregated[,eonr_pred := ceiling(predict(reg_model_stuff$xgb_2, prediction_set_aggregated)/10)*10]
  ...
  #===================================================================================================================
  # 33) PREDICT WITH REGIONAL -VR
  
  # GET THE RECOMMENDATION FOR THE Z11-30 FOR EACH MUKEY AND PERFORMANCE EVALUATION
  testing_set <- ic_field_dt[!z %in% training_z] %>% 
    .[,eonr_pred := ceiling(predict(reg_model_stuff$xgb_2, . )/10)*10] %>%
    .[N_fert == eonr_pred] %>% 
    .[,c("mukey", "z", "id_10", "area_ha", "Yld", "leach_n2", "n_deep_v5", "N_fert", 'P' )] %>% .[order(mukey, z)]
  ...
  #===================================================================================================================
  # 34) PREDICT WITH REGIONAL - UR 
  # GET THE RECOMMENDATION FOR THE Z11-30 FOR EACH MUKEY
  
  prediction_set_aggregated[,eonr_pred := ceiling(predict(reg_model_stuff$xgb_3, prediction_set_aggregated)/10)*10]
  ...
  #===================================================================================================================
  # 35) PREDICT WITH REGIONAL -VR
  
  # GET THE RECOMMENDATION FOR THE Z11-30 FOR EACH MUKEY AND PERFORMANCE EVALUATION
  testing_set <- ic_field_dt[!z %in% training_z] %>% 
    .[,eonr_pred := ceiling(predict(reg_model_stuff$xgb_3, . )/10)*10] %>%
    .[N_fert == eonr_pred] %>% 
    .[,c("mukey", "z", "id_10", "area_ha", "Yld", "leach_n2", "n_deep_v5", "N_fert", 'P' )] %>% .[order(mukey, z)]
  ...
  prediction_set_aggregated[,eonr_pred := ceiling(predict(model1_local_ur, prediction_set_aggregated)/10)*10]
  ...
  # PERFORMANCE EVALUATION
  testing_set <- ic_field_dt[!z %in% training_z] %>% 
    .[,eonr_pred := ceiling(predict(model1_local_vr, .)/10)*10] %>%
    .[N_fert == eonr_pred] %>% 
    .[,c("mukey", "z", "id_10", "area_ha", "Yld", "leach_n2", "n_deep_v5", "N_fert", 'P' )] %>% .[order(mukey, z)]
  ...
  # plot(model2_local_ur)
  # varImpPlot(model2_local_ur, type=2)
  prediction_set_aggregated[,eonr_pred := ceiling(predict(model2_local_ur, prediction_set_aggregated)/10)*10]
  ...
  # PERFORMANCE EVALUATION
  testing_set <- ic_field_dt[!z %in% training_z] %>% 
    .[,eonr_pred := ceiling(predict(model2_local_vr, .)/10)*10] %>%
    .[N_fert == eonr_pred] %>% 
    .[,c("mukey", "z", "id_10", "area_ha", "Yld", "leach_n2", "n_deep_v5", "N_fert", 'P' )] %>% .[order(mukey, z)]
  ...
  testing_set_dt[, .(Yld =  mean(Yld),
                      ...
                      N_fert = mean(N_fert),
                      P = mean(P),
                      area_ha = sum(area_ha)), by = .( model, tech)][order(model)]
...
fields_seq <- sample(1:nrow(fields_list_dt), 300)
...
nopar/500*nrow(fields_list_dt)/60
...
saveRDS(perfomances_dt, "./vr_value_v2/Data/files_rds/perfomances_eonr_dt.rds")
