...
apsim_create_files <- function(i){
  ...
  date_end <- ifelse(instructions_tmp$type == 'stab', '31/12/2008', '30/04/2011') #should be 2009. This is to compare cont vs seq
  ...
  if(instructions_tmp$type == 'stab'){
    ...
    crop_seq <- c('soybean', 'maize', 'soybean', 'nil', 'nil', 'nil', 'nil', 'nil', 'nil', 'nil')
    } 
  ...
  if(instructions_tmp$type == 'YC'){
    source('./vr_value/Codes/update_ic_May25.R')
