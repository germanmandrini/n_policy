...
make_yearly_summary <- function(file_n){
  # file_n =  "S:/Bioinformatics Lab/germanm2/n_management_cluster/yc_output/324_680866.rds"
  # file_n <- files_daily[1]
  # file_n <- "S:/Bioinformatics Lab/germanm2/vr_value_v2_cluster/yc_output_1/1367_159876.rds"
  
  # file_n <- "S:/Bioinformatics Lab/germanm2/n_management_cluster/yc_output/1060_173466.rds"
  #--------------------------
  # preparation
  #--------------------------
  #--- load libraries ---#
  ...
  if(!inherits(possibleError, "error")){
    ...
    save_dir <- paste0("./n_management_box/Data/yc_output_summary_", batch_n, '_', water_n)
...
# files_daily <- list.files('./n_management_box/Data/yc_output',full.names = T, recursive = T)
