...
saveRDS(grid10_soils_dt4, "./n_management_box/Data/Grid/grid10_soils_dt4.rds")
saveRDS(grid10_fields_sf2, "./n_management_box/Data/Grid/grid10_fields_sf2.rds")
...
if(FALSE){
  ...
  grid10_region_by_hand <- sf::read_sf('./n_management_box/Data/shapefiles/grid10_region_by_hand_mrtn.shp')
  ...
  #Add hybrids
  # grid10_tiles_sf6 <- readRDS("./n_management_box/Data/Grid/grid10_tiles_sf6.rds")
  # hybrids_by_hand_sf <- sf::read_sf('./n_management_box/Data/shapefiles/hybrids_by_hand.shp')
  ...
  # saveRDS(grid10_tiles_sf6, "./n_management_box/Data/Grid/grid10_tiles_sf6.rds")
  # st_write(grid10_tiles_sf6, "./n_management_box/Data/shapefiles/grid10_tiles_sf6.shp", delete_dsn = TRUE)
}  