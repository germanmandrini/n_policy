...
grid10_tiles_GRS80_sf <- st_transform(grid10_tiles_sf2, crs_cdl@projargs)
...
library('fasterize')
r <- fasterize(grid10_tiles_GRS80_sf, CFL_r, field = "id_10")

corn_count_dt <- data.table( id_10 = getValues(r),
...
grid10_tiles_sf3 <- merge(grid10_tiles_sf2, corn_count_dt4, by = 'id_10') 


saveRDS(grid10_tiles_sf3, "./vr_value_v2/Data/Grid/grid10_tiles_sf3.rds")  
