...
grid10_fields_sf <- readRDS('./n_management_box/Data/Grid/grid10_fields_sf.rds')
...
for(tile_n in c(22,23)){
  ...
  source('./n_management_box/Data/APssurgo_master/R/get_soils_parallel.R')
...
saveRDS(grid10_soils_list, "./n_management_box/Data/Grid/grid10_soils_list.rds")
...
source('./n_management_box/Data/APssurgo_master/R/get_soils_seq.R')
...
saveRDS(grid10_soils_sf2, "./n_management_box/Data/Grid/grid10_soils_sf2.rds")
grid10_soils_sf2 <- readRDS("./n_management_box/Data/Grid/grid10_soils_sf2.rds")

#---------------------------------------------------------------  
# Clean the soils (replace small areas by biggest)
source('./n_management_git/Codes/clean_fields_step1.R')
grid10_soils_dt3 <- readRDS("./n_management_box/Data/Grid/grid10_soils_dt3.rds")
length(unique(grid10_soils_dt3$mukey)) #total soils to download

#---------------------------------------------------------------  
# Step 2 get the horizons information
source('./n_management_box/Data/APssurgo_master/R/get_horizons_parallel.R')
...
source('./n_management_git/Codes/clean_fields_step2.R')
...
# saveRDS(grid10_horizons_v2_dt, "./n_management_box/Data/Grid/grid10_horizons_v2_dt.rds")
# grid10_horizons_v2_dt <- readRDS("./n_management_box/Data/Grid/grid10_horizons_v2_dt.rds")
#---------------------------------------------------------------
...
saveRDS(regions_horizons_dt, "./n_management_box/Data/Grid/regions_horizons_dt.rds")

#---------------------------------------------------------------
grid10_soils_dt4 <- readRDS("./n_management_box/Data/Grid/grid10_soils_dt4.rds")

grid10_soils_dt4_old <- readRDS("./n_management_box/Data/Grid/grid10_soils_dt4_old.rds")
...
saveRDS(grid10_soils_dt4, "./n_management_box/Data/Grid/grid10_soils_dt4_difference.rds")
