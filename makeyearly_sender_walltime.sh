...
do
	...
	# ./apsim_bash.sh $i
	qsub -v cell_n=$cell_n -l walltime=00:$walltime_n:00 -N $cell_n ./makeyearly_bash.sh #send the cell_n as argument to the script and the walltime in the command line
